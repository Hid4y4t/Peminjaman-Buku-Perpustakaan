                                            ...
                                            <td><?= $d['id_buku'] ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-outline-warning"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#warning<?= $d['id_buku'] ?>"><i
                                                            class="bi bi-eye"></i> Edit</button>



                                                    <!-- form edit buku -->
                                                    <div class="modal fade text-left" id="warning<?= $d['id_buku'] ?>"
                                                        tabindex="-1" role="dialog" aria-labelledby="myModalLabel160"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                            role="document">
                                                    ...
                                                    <a href="#" class="btn icon icon-left btn-danger delete-button" data-book-id="<?= $d['id_buku'] ?>"><i class="bi bi-trash"></i> Hapus</a>
