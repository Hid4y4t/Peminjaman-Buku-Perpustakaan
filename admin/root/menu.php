...
<div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                  <a href="index.php"><img src="../logo/<?= $d['logo'] ?>" alt="Logo" srcset=""></a> 
                  <?= $d['nama'] ?>
                  <h6><?= $d['keterangan'] ?></h6>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  ">
                            <a href="pengaturan-buku.php" class='sidebar-link'>
                                <i class="bi bi-tag"></i>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="riwayat-peminjaman-all.php" class="submenu-link">Peminjaman</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="riwayat-buku.php" class="submenu-link">Data Buku</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="denda.php" class="submenu-link">Denda</a>
                        ...
                        <li class="sidebar-item  ">
                            <a href="panduan.php" class='sidebar-link'>
