...
?>
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">
                                        Riwayat Peminjaman <a href="buat-pengembalian.php?id_anggota=<?= isset($idAnggota) ? $idAnggota : "Tidak ditemukan" ?>" class="btn icon icon-left btn-success"><i class="bi bi-back"></i>
                                Kembali </a>
                                    </h5>
                                </div>
                                <div class="card-body">
